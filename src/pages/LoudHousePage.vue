...
<script setup>
const imageModules = import.meta.glob('../assets/imgs/loud house/*.{png,jpg,jpeg,webp,gif}', { eager: true, as: 'url' })
const videoModules = import.meta.glob('../assets/imgs/loud house/*.{mp4,mov}', { eager: true, as: 'url' })
