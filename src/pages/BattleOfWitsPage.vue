...
<script setup>
const imageModules = import.meta.glob('../assets/imgs/battle of wits/*.{png,jpg,jpeg,webp,gif}', { eager: true, as: 'url' })
const videoModules = import.meta.glob('../assets/imgs/battle of wits/*.mov', { eager: true, as: 'url' })
